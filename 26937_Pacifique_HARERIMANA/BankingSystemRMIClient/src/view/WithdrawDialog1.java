 ...
 */
public class WithdrawDialog1 extends javax.swing.JFrame {

    public WithdrawDialog1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CUSTOMER WITHDRAW");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(withdrawAmountTxt, javax.swing.GroupLayout.Alignment.LEADING)))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void withdraw() {
        if(accountNumberTxt.getText().trim().isEmpty() || withdrawAmountTxt.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(this, "All fields required!");
            return;
        }
        
        try{
            double amount = Double.parseDouble(withdrawAmountTxt.getText().trim());
            if(amount <= 0){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WithdrawDialog1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
